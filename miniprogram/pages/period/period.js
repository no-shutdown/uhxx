...
Page({
    ...
    // 症状备注输入
    onSymptomNoteInput(e) {
        this.setData({
            'symptomForm.note': e.detail.value
        });
    },
    // 提交经期记录
    submitPeriodRecord(e) {
    ...
    submitSymptomRecord(e) {
        ...
        try {
            ...
            const existingIndex = periodData.symptoms.findIndex((s) => s.date === symptomForm.date);
            if (existingIndex > -1) {
